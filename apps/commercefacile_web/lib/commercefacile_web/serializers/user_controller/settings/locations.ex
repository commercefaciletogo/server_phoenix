defmodule Commercefacile.Web.Serializers.UserController.Settings.Locations do
    use Remodel
    ...
    def subs(%{children: children}) do
        Commercefacile.Web.Serializers.UserController.Settings.Locations.Children.to_list(children)
    end
    ...
    def to_list(collections, :select) do
        collectable = fn 
            ...
            %{name: name, children: children, id: _id} ->
                {"#{name}", Commercefacile.Web.Serializers.UserController.Settings.Locations.Children.to_list(children, :select)}
        end
