data = [
    %Commercefacile.Locations.Location{
        id: 1,
        name: "Maritime",
        uuid: Ksuid.generate(),
        svg: "M240.7 576.6l-.6.3-1.1 1-2.5 4.5-.7 1.1-.7.8-2.2 1.3-2.1.8-.7.1-1.5-.1-1.5-.3-2.7-1-1.1-.1-1.5.1-2.7.7-2.3 1-8.3 7-6.7 7.5-1-.5-3.8-1.5-.9-.9-1.4-2.7-.4-.5-.7-.4-1.2-.5-.5-.4-1.1-1.5-.6-.3-2.1-.3-.5-.3-.2-.5.3-1-.2-.4-.6-.2-19.6-1.3-2.3.6-1.2.5-1.1.7-.6.6-.5.9-.4 1.6-.2 1.6.3 6.5-.5 5.3-.8 3-.5 1.3-.6 1-.8 1.1-3.5 3.7-1.1 1.6-1.2 2.3-.8 1.1-.4.4-4.2 2.9-2 .9-6.2 1-.2 2.8.7 3.3 1.5 3.3 1.9 3.3 2.5 2.9 5.9 3.3 3 2.2 3.9 5.3 1.5 1.3 2.5.7h9.2l3.1 10.9 1.9 3 1 .8.9.4.9.6.9 1.2 1.6 2.8 1.3 1.7 1.7.9 9.9 1.3 1.4 2.2-.3 4.8.7-.2 1-.1 8.6-4.2 19-6.6 22.8-4.4-.8-2.9 2.5-1.5 15.4-4.1 2.5-.2-2.3-10-2.3-10.2-3.1-5.6-1-.9-2.6-1.5-.8-.7-.3-1.2.3-2.9-.1-1.4-.8-1.1-2-1.9-.3-.9-.2-1.6-.9-.4-1.2.1-1.1-.2-1-.6-1-.9-.9-1.1-.7-1.1-.4-1.4.1-1.3.2-1.1v-1.1l-1.3-2.7-1.6-1.4-.8-1.5 1-3 2.7-4.1.5-2.1-.7-3.3-.9-2.8-.5-2.3-.1-2.3.9-5.7-.3-1.9-1.1-1.5-1.8-1.3z",
        country_id: 1
    },
    %Commercefacile.Locations.Location{
        id: 2,
...
Enum.each(data, fn location -> Commercefacile.Repo.insert!(location) end)